...
export const tuning: {
  ...
  weapons: {
    ...
    laserBeamTtlMs: 95,
    laserBeamWidth: 1.35,
    muzzleFlashTtlMs: 130,
    impactSparkTtlMs: 140,
    missileTrailLength: 7,
    missileTrailTtlMs: 260,
  },
  targeting: {
    screenRadiusNdc: 0.6,
    stickyTimeSec: 0.7,
  ...
  environment: {
    galacticBandIntensity: 0.42,
    galacticBandWidth: 0.4,
    galacticBandTiltDeg: 26,
    sunDirection: [0.4, 0.2, -0.9],
    sunIntensity: 0.72,
    sunSpriteSize: 8.5,
    sunHaloIntensity: 0.48,
  },
  look: {
